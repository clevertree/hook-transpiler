      ...
      fn(
        (spec: string) => {
          ...
          if (spec === '@clevertree/markdown') {
            return (context as any).__relay_builtins?.['@clevertree/markdown'] || (globalThis as any).__relay_builtins?.['@clevertree/markdown'] || {}
          }
          if (spec === '@clevertree/theme') {
            return (context as any).__relay_builtins?.['@clevertree/theme'] || (globalThis as any).__relay_builtins?.['@clevertree/theme'] || {}
          }
