            ...
            <div className="space-y-6">
                <div className="bg-bg p-4 rounded-lg border-themed">
                    ...
                    <div className="flex flex-row items-center justify-between">
                        ...
                        <div className="flex flex-row space-x-2">
                            <button onClick={() => setCount(count - 1)} className="bg-surface border-themed px-3 py-1 rounded shadow-sm text-themed">-</button>
                            <button onClick={() => setCount(count + 1)} className="bg-surface border-themed px-3 py-1 rounded shadow-sm text-themed">+</button>
                            <button onClick={() => setCount(0)} className="bg-bg px-3 py-1 rounded shadow-sm text-xs text-muted">Reset</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-bg p-4 rounded-lg border-themed">
                    ...
                    <div className="space-y-3">
                        <div className="bg-surface p-2 border-themed rounded text-themed min-h-[40px]">
                            {text}
                        </div>
                        <div className="flex flex-row space-x-2">
                            ...
                            <button onClick={() => setText('Initial')} className="bg-bg text-muted px-3 py-1 rounded text-xs font-medium">Reset</button>
                        </div>
                    </div>
                </div>
            </div>
