...
//# sourceURL=${filename}
    ...
    normalizePath(modulePath) {
        ...
        // Handle @clevertree/* or other scoped imports
        if (modulePath.startsWith('@')) {
            // @clevertree/shared is rewired to local src/shared, but for runtime hooks
            // it should probably be handled by the host or mapped to a public URL.
...
//# sourceMappingURL=es6ImportHandler.js.map